...
import { RSVP, DashboardStats, WeddingInvitation } from "../types";
import { LanguageCode, translations } from "../translations";
import ShareModal from "./ShareModal";

interface DashboardViewProps {
  lang: LanguageCode;
  onEditInvitation: (slug: string, previewData?: WeddingInvitation) => void;
}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-sm space-y-6 flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-2.5">
            <button
              onClick={() => onEditInvitation(activeSlug, activeInvitation || undefined)}
