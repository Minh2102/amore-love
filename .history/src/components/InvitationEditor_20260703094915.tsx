...
export default function InvitationEditor({ selectedTemplateId, onPreviewInvitation, lang }: InvitationEditorProps) {
  ...
  const builtInSongs = [
    ...
    },
    {
      ...
      url: "https://www.mfiles.co.uk/mp3-downloads/canon-in-d.mp3"
    },
    {
      title: "Wedding Romance - Piano",
      url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3"
    },
    {
      title: "Acoustic Love - Chill",
                  ...
                  <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {builtInSongs.map((song) => (
                      <button
                        ...
                        className="w-full rounded-2xl border border-stone-200 bg-white px-4 py-3 text-left text-xs text-stone-700 hover:border-rose-300 hover:bg-rose-50 transition-all"
                      >
                        <div className="font-semibold text-sm text-stone-900">{song.title}</div>
